...
/**
 * Mirrors DesktopLoginView — same split-screen hero, only the form card and
 * copy differ, sharing useForgotPasswordForm().
 */
export default function DesktopForgotPasswordView() {
      ...
      <div className="relative flex flex-col justify-between overflow-hidden bg-[var(--bg-elev)] px-14 py-10">
        <div>
          ...
          <p className="mt-4 max-w-[420px] text-[14.5px] leading-[1.6] text-[var(--text-dim)]">
            Happens to the best of us. We&apos;ll email you a link to set a new password.
          </p>
