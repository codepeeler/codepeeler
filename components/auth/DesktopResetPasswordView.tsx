...
/**
 * Mirrors DesktopLoginView/DesktopForgotPasswordView — same split-screen
 * hero, sharing useResetPasswordForm().
 */
export default function DesktopResetPasswordView() {
      ...
      <div className="relative flex flex-col justify-between overflow-hidden bg-[var(--bg-elev)] px-14 py-10">
        <div>
          ...
          <p className="mt-4 max-w-[420px] text-[14.5px] leading-[1.6] text-[var(--text-dim)]">
            Set a new password and you&apos;ll be right back in your workspace.
          </p>
