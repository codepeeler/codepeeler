...
export default function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-50 hidden h-[60px] flex-shrink-0 items-center gap-5 border-b border-[var(--border-soft)] bg-[var(--bg)]/85 px-5 backdrop-blur-md lg:flex">
