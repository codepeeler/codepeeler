...
export const TOOLS: Tool[] = [
  { id: "json", name: "JSON Formatter", desc: "Format & validate JSON", badge: "{ }", cat: "data", page: "/tools/json-formatter" },
  ...
  { id: "jwt", name: "JWT Decoder", desc: "Decode JWT tokens", badge: "JWT", cat: "sec", page: null },
  { id: "color", name: "Color Picker", desc: "Pick & convert colors", badge: "◐", cat: "image", page: null },
  { id: "qr", name: "QR Generator", desc: "Generate QR codes", badge: "▦", cat: "gen", page: null },
];
