...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    price: { monthly: 1299, yearly: 1049 },
    perUser: true,
    comingSoon: true,
    features: [
      "Everything in Pro",
    ...
    cta: { label: "Coming Soon", type: "contact" },
  },
  {
    key: "enterprise",
    name: "Enterprise",
...
export const COMPARE_ROWS: { label: string; values: [string, string, string, string] }[] = [
  ...
  { label: "Executions / month", values: ["100", "10,000", "20,000 / user", "Unlimited"] },
  { label: "Storage", values: ["100 MB", "10 GB", "20 GB / user", "Unlimited"] },
