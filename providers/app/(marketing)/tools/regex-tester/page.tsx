  ...
  const highlighted = useMemo(() => {
    ...
    matches.forEach((m, i) => {
      ...
      parts.push(
        <mark
          key={i}
          className="rounded-[3px] bg-[color-mix(in_srgb,var(--primary)_35%,transparent)] px-0.5 text-[var(--text)]"
        >
          {m[0]}
        </mark>
      );
        ...
        <div className="grid grid-cols-1 gap-3.5 p-4 md:grid-cols-2">
          <div className="overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card)]">
            ...
            <textarea
              ...
              className="h-[200px] w-full resize-none bg-transparent p-3 font-[family-name:var(--font-mono)] text-[13px] leading-[1.6] text-[var(--text)] placeholder:text-[var(--text-faint)]"
            />
          </div>
          ...
          <div className="overflow-hidden rounded-[var(--radius-md)] border border-[var(--border)] bg-[var(--card)]">
            <div className="flex items-center justify-between border-b border-[var(--border-soft)] px-3 py-2">
              ...
              <span className="text-[11.5px] text-[var(--text-faint)]">{matches.length}</span>
            </div>
            <div className="h-[200px] overflow-auto whitespace-pre-wrap break-words p-3 font-[family-name:var(--font-mono)] text-[13px] leading-[1.6] text-[var(--text)]">
              {highlighted}
            </div>
          </div>
        </div>
